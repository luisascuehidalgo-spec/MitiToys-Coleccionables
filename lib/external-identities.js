...
async function shipmentConflictOwner(sql, error, shipmentId, orderId) {
  if (!isUniqueViolation(error) || !shipmentId) return null;
  return shipmentOwner(sql, shipmentId, orderId);
}
