...
test('product image preload accepts HTTPS and rejects insecure or malformed URLs', () => {
  assert.equal(
    productImagePreload(['https://res.cloudinary.com/demo/image/upload/example.jpg']),
    '<https://res.cloudinary.com/demo/image/upload/example.jpg>; rel=preload; as=image'
  );
