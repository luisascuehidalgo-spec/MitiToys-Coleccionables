...
module.exports = async (req, res) => {
  ...
  try {
    if (req.method === 'POST') {
      ...
      const rows = await sql`INSERT INTO products(id,title,description,images,price,stock_quantity,stock_managed,active,created_at,updated_at) VALUES(${id},${title},${description},${JSON.stringify(images)}::jsonb,${price},${stock},${stockManaged},${active},NOW(),NOW()) RETURNING *`;
